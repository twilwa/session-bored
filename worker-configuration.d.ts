/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 2476a61e8e69d1221943f7a19b1b1da5)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	ASSETS: Fetcher;
	APP_ORIGIN: "https://session-bored.techwilliams-warren.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
